...
typedef struct {
  ...
  __DECLARE_LOCATED(BOOL,FLOWRATEALARM0)
  __DECLARE_LOCATED(BOOL,FLOWRATEALARM1)
  __DECLARE_LOCATED(BOOL,FLOWRATEALARM2)
  ...
  __DECLARE_LOCATED(INT,FLOWSENSORMAXCAPACITY)
